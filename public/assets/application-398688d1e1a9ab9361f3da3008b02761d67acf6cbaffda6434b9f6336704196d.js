...
(function() { this.JST || (this.JST = {}); this.JST["accounts/account_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="/#accounts/',  account.get("id") ,'" class="account-link" data-id="',  account.get("id") ,'">',  account.institution().escape("name") ,' - ',  account.escape("account_type") ,'</a>\n<p>$',  account.amount ,'</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["accounts/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n\n\n<h1>New Account</h1><br>\n  <label for="acct-inst-name">Institution Name: </label><br>\n  <select name="institution_id" id="acct-inst-name">\n    ');  institutions.forEach(function(institution){ ; __p.push('\n      <option value="',  institution.escape("id") ,'">',  institution.escape("name") ,'</option>\n    ');  }) ; __p.push('\n    <option value="">Other</option>\n  </select><br>\n\n  <div class="display-none" id="hidden-input">\n    <label>Other Institution Name: </label><br>\n    <input id="acct-inst-name" type="text" name="institution_name" value="',  account.escape("name") ,'">\n  </div><br>\n\n  <label for="acct-type">Account Type: </label><br>\n  <select name="account_type" id="acct-type">\n    ');  types.forEach(function(type){ ; __p.push('\n      <option value="',  type ,'">', type,'</option>\n    ');  }) ; __p.push('\n  </select><br><br>\n\n  <button>Create Account</button> or <a class="cancel-form" href="#">Cancel</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["accounts/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="group" id="sidebar">\n\n<h1>Accounts</h1><button>+</button>\n\n<section>\n  <h5>Cash</h5>\n  <ul class="cash">\n\n  </ul>\n</section>\n<section>\n  <h5>Credit Card</h5>\n  <ul class="credit">\n\n  </ul>\n</section>\n<section>\n  <h5>Loans</h5>\n  <ul class="loan">\n\n  </ul>\n</section>\n<section>\n  <h5>Investments</h5>\n  <ul class="investment">\n\n  </ul>\n</section>\n<section>\n  <h5>Property</h5>\n  <ul class="property">\n\n  </ul>\n</section>\n\n</div>\n  <div class="modal-window"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["accounts/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="group" id="sidebar">\n  <div>\n    <h2>Type</h2>\n    <ul>\n      <li><a href="#">Cash & Credit</a></li>\n      <li><a href="#">Investment</a></li>\n      <li><a href="#">Loan</a></li>\n    </ul><br>\n\n    <h2>Accounts</h2>\n    <ul>\n      <li><a href="#accounts/">All Accounts</a></li><br>\n      ');  accounts.forEach(function(account){ ; __p.push('\n        <li><a href="#/accounts/', account.get("id"),'" >\n          <p class="sidebar-account-title">',  account.institution().escape("name") ,'<p>\n          <p class="sidebar-account-description">',  account.institution().escape("name") ,' ',  account.escape("account_type") ,'<p>\n          </a>\n        </li><br>\n      ');  }) ; __p.push('\n    </ul>\n  </div>\n</div>\n\n<div class="main-window">\n\n<h1>',  model.institution().escape("name"),'</h1>\n<h1>',  model.escape("account_type"),'</h1>\n\n<button class="add-trans">Add Transaction</button>\n\n<table class="transactions-list">\n    <th>Date</th>\n    <th>Description</th>\n    <th>Category</th>\n    <th>Amount</th>\n</table>\n\n</div>\n\n<div class="modal-window"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["transactions/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> New Transaction </h1>\n\n<label for="date">Date: </label><br>\n<input id="date" type="date" name="transaction_date" value="',  model.escape("transaction_date") ,'"><br>\n\n<label for="description">Description: </label><br>\n<input id="description" type="text" name="description" value="',  model.escape("description") ,'"><br>\n\n<label for="category">Category: </label><br>\n<select name="category" id="category">\n  ');  categories.forEach(function(category){ ; __p.push('\n    <option value="',  category ,'">',  category ,'</option>\n  ');  }) ; __p.push('\n</select><br>\n\n<label for="amount">Amount: </label><br>\n$ <input id="amount" type="number" name="amount" value="',  model.escape("amount") ,'"><br>\n\n<label for="notes">Notes: </label><br>\n<textarea id="notes" name="notes">',  model.escape("notes") ,'</textarea><br>\n\n<button class="create-transaction">Create Transaction</button> or <a class="cancel-form" href="#">Cancel</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["transactions/transaction_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n  <td>',  transaction.escape("transaction_date") ,'</td>\n  <td>',  transaction.escape("description") ,'</td>\n  <td>',  transaction.escape("category") ,'</td>\n  <td>',  transaction.escape("amount") ,'</td>\n');}return __p.join('');};
}).call(this);
